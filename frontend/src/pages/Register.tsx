    ...
    <div className="min-h-screen pt-24 pb-12">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="mb-12">
          <div className="flex justify-between items-center relative z-10">
            {steps.map((step, idx) => (
              <div key={idx} className="flex flex-col items-center">
                <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm transition-colors duration-300 ${idx <= currentStep ? 'bg-amber-400 text-slate-900' : 'bg-slate-800 text-slate-500'}`}>
          ...
          <div className="absolute top-[8.5rem] left-0 w-full h-0.5 bg-slate-800 -z-0">
             {/* Note: Absolute positioning relative to screen might be tricky, usually I'd use a container. 
                 Simplifying visual for code brevity */}
          </div>
        </div>
