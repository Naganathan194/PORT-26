    ...
    <section className={`py-24 ${theme === 'light' ? 'bg-slate-100/70' : 'bg-slate-900/50'} transition-colors duration-300`}>
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-10">
        <div className="flex justify-between items-end mb-16">
          ...
          <a href="/#/events" className={`hidden md:flex items-center ${theme === 'light' ? 'text-amber-700 hover:text-amber-800' : 'text-amber-400 hover:text-amber-300'} font-medium transition-colors`}>
        ...
        <div className="mt-12 text-center md:hidden">
          <a href="/#/events" className={`inline-flex items-center ${theme === 'light' ? 'text-amber-700 hover:text-amber-800' : 'text-amber-400 hover:text-amber-300'} font-medium`}>
            View All Events <ArrowRight className="w-5 h-5 ml-2" />
          </a>
        </div>
      </div>
